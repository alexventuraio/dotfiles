" Put this file inside `~/.nvim/autoload/airline/themes` folder
...
"
" For this, the dark_alex.vim, theme, this is defined as
let g:airline#themes#dark_alex#palette = {}

" Keys in the dictionary are composed of the mode, and if specified the
" override.  For example:
"   * g:airline#themes#dark_alex#palette.normal 
"       * the colors for a statusline while in normal mode
"   * g:airline#themes#dark_alex#palette.normal_modified 
"       * the colors for a statusline while in normal mode when the buffer has
"         been modified
"   * g:airline#themes#dark_alex#palette.visual 
...
let g:airline#themes#dark_alex#palette.normal = airline#themes#generate_color_map(s:airline_a_normal, s:airline_b_normal, s:airline_c_normal)

" It should be noted the above is equivalent to:
" let g:airline#themes#dark_alex#palette.normal = airline#themes#generate_color_map(
...
" let g:airline#themes#dark_alex#palette.normal = {
...
" applied after g:airline#themes#dark_alex#palette.normal, hence why only certain keys are
" declared.
let g:airline#themes#dark_alex#palette.normal_modified = {
...
let g:airline#themes#dark_alex#palette.insert = airline#themes#generate_color_map(s:airline_a_insert, s:airline_b_insert, s:airline_c_insert)
let g:airline#themes#dark_alex#palette.insert_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 255     , 53      , ''     ] ,
      \ }
let g:airline#themes#dark_alex#palette.insert_paste = {
      \ 'airline_a': [ s:airline_a_insert[0]   , '#d78700' , s:airline_a_insert[2] , 172     , ''     ] ,
      \ }

let g:airline#themes#dark_alex#palette.terminal = airline#themes#generate_color_map(s:airline_a_insert, s:airline_b_insert, s:airline_c_insert)

let g:airline#themes#dark_alex#palette.replace = copy(g:airline#themes#dark_alex#palette.insert)
let g:airline#themes#dark_alex#palette.replace.airline_a = [ s:airline_b_insert[0]   , '#af0000' , s:airline_b_insert[2] , 124     , ''     ]
let g:airline#themes#dark_alex#palette.replace_modified = g:airline#themes#dark_alex#palette.insert_modified
...
let g:airline#themes#dark_alex#palette.visual = airline#themes#generate_color_map(s:airline_a_visual, s:airline_b_visual, s:airline_c_visual)
let g:airline#themes#dark_alex#palette.visual_modified = {
      \ 'airline_c': [ '#ffffff' , '#5f005f' , 255     , 53      , ''     ] ,
      \ }
...
let s:airline_c_inactive = [ '#7e7e7e' , '#303030' , 239 , 236 , '' ]
let g:airline#themes#dark_alex#palette.inactive = airline#themes#generate_color_map(s:airline_a_inactive, s:airline_b_inactive, s:airline_c_inactive)
let g:airline#themes#dark_alex#palette.inactive_modified = {
      \ 'airline_c': [ '#875faf' , '' , 97 , '' , '' ] ,
      \ }
...
let g:airline#themes#dark_alex#palette.commandline = airline#themes#generate_color_map(s:airline_a_commandline, s:airline_b_commandline, s:airline_c_commandline)
...
let g:airline#themes#dark_alex#palette.accents = {
      \ 'red': [ '#ff0000' , '' , 160 , ''  ]
      \ }
...
if get(g:, 'loaded_ctrlp', 0)
  let g:airline#themes#dark_alex#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(

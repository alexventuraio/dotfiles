...
let g:airline#themes#alex_material#palette = {}
...
let g:airline#themes#alex_material#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
let g:airline#themes#alex_material#palette.normal_modified = s:modified
...
let g:airline#themes#alex_material#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
let g:airline#themes#alex_material#palette.insert_modified = s:modified
...
let g:airline#themes#alex_material#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
let g:airline#themes#alex_material#palette.visual_modified = s:modified
...
let g:airline#themes#alex_material#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3)
let g:airline#themes#alex_material#palette.replace_modified = s:modified
...
let g:airline#themes#alex_material#palette.inactive = airline#themes#generate_color_map(s:IN1, s:IN2, s:IN3)
let g:airline#themes#alex_material#palette.inactive_modified = s:modified
...
let g:airline#themes#alex_material#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(s:CP1, s:CP2, s:CP3)

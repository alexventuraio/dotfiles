" Put this file inside `~/.vim/colors` folder
" -----------------------------------------------------------------------------
...
let g:colors_name = "alex-material"
...
call s:hi("CursorLine",   s:gui.none,       s:gui.line,       "", "", "none")
call s:hi("CursorLineNr", s:gui.cyan,       s:gui.line,       "", "", "none")
...
call s:hi("Search",      s:gui.background, s:gui.purple,     "", "", "")
call s:hi("IncSearch",   s:gui.red,        s:gui.foreground, "", "", "")

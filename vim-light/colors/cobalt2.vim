...
call s:X("CursorColumn","",g:cobalt_cursorline,"","","Black")
call s:X("CursorLine","",g:darker_blue,"","","Black")
...
call s:X("SignColumn","",g:cobalt_bg,"","","")
...
call s:X("rubyBlockParameter",g:red,"","","Blue","")
call s:X("rubyBlockParameterList",g:light_yellow,"","","Blue","")

call s:X("rubyInterpolation",g:lighter_green,"","","Magenta","")
call s:X("rubyInterpolationDelimiter",g:light_grey,"","","Magenta","")
...
call s:X("rubyClassName",       g:light_yellow, "", "", "", "bold")
call s:X("rubyConstant",        g:dirty_pink, "", "", "", "")
call s:X("rubyKeywordAsMethod", g:blue,   "", "", "", "")
call s:X("rubyOperator",        g:green, "", "", "", "")
call s:X("rubyPseudoVariable",  g:red,   "", "", "", "italic")
call s:X("rubySymbolDelimiter", g:light_blue,   "", "", "", "")
...
"eRuby colors
call s:X("eRubyDelimiter", g:lightest_pink, "", "italic", "", "")
call s:X("eRubyComment",g:dark_blue,"","italic","Grey","")
" call s:X("erubyRailsMethod", ctermfg=150 ctermbg=NONE cterm=NONE guifg=#a9dc76 guibg=NONE gui=NONE)
...
call s:X("jsReturn",g:blue,"", "italic", "", "")
...
" call s:X("htmlArg",g:light_yellow,"","italic","","")
call s:X("htmlArg",g:dark_orange,"","italic","","")
...
call s:X("GitGutterAdd",          g:green,        g:cobalt_bg, "", "", "")
call s:X("GitGutterChange",       g:light_yellow, g:cobalt_bg, "", "", "")
call s:X("GitGutterDelete",       g:red,          g:cobalt_bg, "", "", "")
call s:X("GitGutterChangeDelete", g:blue,         g:cobalt_bg, "", "", "")

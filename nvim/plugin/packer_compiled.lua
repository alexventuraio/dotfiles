...
_G.packer_plugins = {
  ...
  bufexplorer = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/bufexplorer",
  ...
  ["cmp-nvim-ultisnips"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/cmp-nvim-ultisnips",
  ...
  ["nvcode-color-schemes.vim"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/nvcode-color-schemes.vim",
  ...
  ultisnips = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/ultisnips",
    url = "https://github.com/SirVer/ultisnips"
  },
  ["vim-bundler"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/vim-bundler",
  ...
  ["vim-multiple-cursors"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/vim-multiple-cursors",
    url = "https://github.com/terryma/vim-multiple-cursors"
  },
  ["vim-rails"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/vim-rails",
  ...
  ["vim-ruby"] = {
    loaded = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/start/vim-ruby",
